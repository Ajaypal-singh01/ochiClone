...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-800 px-10   flex">
      <div className="w-1/2  flex flex-col justify-between pb-10">
        <div className="font-grotexsk text-[5vw] font-semibold">
          <h1 className="  -mb-7 ">EYE-</h1>
          <h1 className="  -mb-7">OPENING</h1>
        </div>
        <div>
          <svg
            width="72"
      ...
      <div className="w-1/2 relative ">
        <h1 className="uppercase font-grotexsk  text-[5vw] font-semibold">
          presentations
        </h1>
          ...
          <div className="w-1/2 ">
            ...
            <div className="w-full mt-5 ">
              ...
              <div className="mt-5">
                ...
                <p>30 Chukarina St Lviv,</p>
              </div>
            </div>
            <div className="w-full mt-5">
              <div>E: </div>
              <div className="mt-5">hello@ochi.design</div>
            </div>
            <div className="absolute bottom-10 text-zinc-400">
              © ochi design 2024. Legal Terms
            </div>
          </div>
          <div className="w-1/2  ">
            <div className="w-full mt-5 ml-48 ">
              <div>M: </div>
              <div className="mt-5">
                <p>Home</p>
                <p>Service </p>
            ...
            <div className=" text-zinc-400 ml-36 absolute bottom-10" >Website by Obys</div>
          </div>
        </div>
      </div>
    </div>
